...
export default async function mailServerConfigured(db: Kysely<AuthDatabase>, redis?: Redis): Promise<boolean> {
  const setting_key = "mail_server_configured" as const;
  try {
