 ...
 * */
export const SchemaVaultsAuthContext =
  createContext<SchemaVaultsAuthContextType>({
    ready: false,
    message:
      "Ensure useAuth() is only called within a <SchemaVaultsAuthProvider> context.",
  });

export default SchemaVaultsAuthContext;
