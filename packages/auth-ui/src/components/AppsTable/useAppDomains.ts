...
import { HARDCODED_CORE_SCHEMAVAULTS_APP_DOMAINS, isHardcodedAppId, type SchemaVaultsAppDomainRef, schemaVaultsAppDomainRefSchema } from "@schemavaults/app-definitions";
